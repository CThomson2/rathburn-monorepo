 ...
 *
 * @param {Object} props
 * @prop {string} activeTab - The active tab id.
 * @prop {Function} setActiveTab - A function to set the active tab.
 * @prop {Function} toggleScanner - A function to toggle the scanner.
 * @prop {boolean} scannerActive - Whether the scanner is active.
 *
