...
import { Calendar, Clock, Download, User, AlertCircle, Activity } from "lucide-react";
...
export function DrumDetailsModal({ drum, open, onClose }: DrumDetailsModalProps) {
          ...
          <TabsContent value="details" className="space-y-4">
            ...
            <div className="pt-4 border-t">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Button size="sm" variant="outline">Mark as Lost</Button>
                <Button size="sm" variant="outline">Decommission</Button>
                <Button size="sm" variant="outline">Transfer Contents</Button>
                <Button size="sm" variant="outline">
