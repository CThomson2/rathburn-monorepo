  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="bg-white rounded-lg shadow-sm p-5 border border-gray-100">
        <div className="flex justify-between items-start">
          <div>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mt-1">{formattedValue}</h3>
          </div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-5 border border-gray-100">
        <div className="flex justify-between items-start">
          <div>
            <p className="text-sm font-medium text-gray-500">Below Safety Stock</p>
            <h3 className="text-2xl font-bold text-gray-900 mt-1">{belowSafetyStock} items</h3>
          </div>
          <div className={cn(
            "p-2 rounded-md",
      ...
      <div className="bg-white rounded-lg shadow-sm p-5 border border-gray-100">
        <div className="flex justify-between items-start">
          <div>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mt-1">{pendingOrders} orders</h3>
          </div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-5 border border-gray-100">
        <div className="flex justify-between items-start">
          <div>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mt-1">{stockAccuracy}%</h3>
          </div>
          <div className={cn(
            "p-2 rounded-md",
            stockAccuracy >= 95 ? "bg-green-100" : 
            stockAccuracy >= 90 ? "bg-yellow-100" : "bg-red-100"
          )}>
            <CheckCircle className={cn(
              "h-5 w-5",
              stockAccuracy >= 95 ? "text-green-600" : 
              stockAccuracy >= 90 ? "text-yellow-600" : "text-red-600"
            )} />
          </div>
        </div>
        <div className="flex items-center mt-4">
          <div className="w-full bg-gray-200 rounded-full h-2.5">
            <div 
              className={cn(
                "h-2.5 rounded-full",
                stockAccuracy >= 95 ? "bg-green-600" : 
                stockAccuracy >= 90 ? "bg-yellow-500" : "bg-red-600"
              )}
