                    ...
                    <div className="box-body !p-0">
                      <div className="p-6">
                        <div className="flex items-center justify-between">
                          <div className="mb-4">
                            <span className="block font-semibold text-[0.9375rem]">
                              Water Tracking
                            </span>
                            <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem] block">
                              87 Points
                            </span>
                          </div>
                          <div>
                        ...
                        <div>
                          <p className="mb-0">
                            ...
                            <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem] ms-1 inline-flex">
                              Lt
                            </span>
                          </p>
                          <span className="text-[#8c9097] dark:text-white/50">
                            0.9 Lt more to reach goal
                          </span>
                        </div>
                      </div>
                      <div id="waterTrack">
                        <ReactApexChart
                          options={Personaldata.Watertracking.options}
                          series={Personaldata.Watertracking.series}
                          type="area"
                          width={"100%"}
                          height={115}
                        />
                    ...
                    <div className="box-body !p-0">
                      <div className="p-6">
                        ...
                        <div>
                          ...
                          <span className="text-[#8c9097] dark:text-white/50">
                            2.8 Hrs more to reach goal
                          </span>
                        </div>
                      </div>
                      <div id="sleepTrack">
                        <ReactApexChart
                          options={Personaldata.Sleeptracking.options}
                          series={Personaldata.Sleeptracking.series}
                          type="area"
                          width={"100%"}
                          height={115}
                        />
                ...
                <div className="box-body !p-0">
                  <div className="flex flex-wrap items-center border-b border-dashed dark:border-defaultborder/10">
                    <div className="px-6 py-4 flex-grow border-e border-dashed dark:border-defaultborder/10">
                      <div className="flex items-center justify-between">
                        <p className="mb-0 flex-grow text-[0.875rem] font-semibold">
                          Instagram
                        </p>
                        <div className="ms-0">
                          <span className="avatar bg-light !text-danger">
                            <i className="bi bi-instagram text-[1rem]"></i>
                          </span>
                        </div>
                      </div>
                      <p className="mb-2 text-[1.5rem] font-semibold">121K</p>
                      <div className="flex-between">
                        <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem]  inline-block">
                          6 min ago
                        </span>
                        <span className="text-danger">
                          <i className="bi bi-arrow-down-right me-1 text-[0.625rem] ms-1"></i>
                          1.5%
                        </span>
                      </div>
                    </div>
                    <div className="px-6 py-4 flex-grow border-b-0 border-dashed dark:border-defaultborder/10">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="ms-2">
                          <span className="avatar bg-light !text-warning">
                            <i className="bi bi-facebook text-[1rem]"></i>
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="px-6 py-4 flex-grow border-e border-dashed dark:border-defaultborder/10">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="ms-1">
                          <span className="avatar bg-light !text-info">
                            <i className="bi bi-youtube text-[1rem]"></i>
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="flex-between">
                        ...
                        <span className="text-info">
                          <i className="bi bi-arrow-up-right me-1 text-[0.625rem] ms-1"></i>
                          1.9%
                        </span>
                      </div>
                    </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="ms-2">
                          <span className="avatar bg-light !text-purple">
                            <i className="ri-twitter-x-line text-[1rem]"></i>
                          </span>
                        </div>
                      </div>
                      <p className="mb-2 text-[1.5rem] font-semibold">2.1K</p>
                  ...
                  <div className="box">
                    <div className="box-body">
                      <div className="flex justify-between mb-6">
                        <div className="me-1">
                          <h6 className="!text-[0.9375rem] font-medium mb-1">
                            Primary Account
                          </h6>
                          <Link
                            href="#!"
                          ...
                          >
                            Change
                            <i className="bi bi-box-arrow-up-right text-[0.6875rem] ms-1"></i>
                          </Link>
                        </div>
                      ...
                      <p className="text-[1.5rem] font-semibold mb-4">
                        $1,29,389.00
                      </p>
                  ...
                  <div className="box">
                    <div className="box-header justify-between">
                      ...
                      <Link href="#!" scroll={false} className="text-primary">
                        View History
                        <i className="bi bi-box-arrow-up-right text-[0.6875rem] ms-2"></i>
                      </Link>
                    </div>
                    <div className="box-body">
                      ...
                      <div className="mt-2">
                        <div className="mt-2">
                          <label className="text-[#8c9097] dark:text-white/50 mb-1">
                            Send / Receive
                          </label>
                          <div className="input-group inline-flex">
                            <span className="input-group-text  !border-e-0 ">
                              Send To
                            </span>
                            <input
                              type="text"
                          ...
                          <label className="text-success text-[0.75rem]">
                            Say Hii
                          </label>
                        </div>
            ...
            <div className="xl:col-span-8 col-span-12">
              <div className="grid grid-cols-12 gap-x-6">
                <div className="xl:col-span-12 col-span-12">
                  <div className="box">
                    <div className="box-header">
                      <div className="box-title">Discover</div>
                    </div>
                    <div className="box-body">
                      ...
                      <ul className="list-none mb-0 personal-upcoming-events">
                        <li>
                          <div className="flex items-center">
                            ...
                            <div>
                              <span className="badge bg-primary/10 text-primary whitespace-nowrap">
                                11-06-2023
                              </span>
                            </div>
                          </div>
                        ...
                        <li>
                          <div className="flex items-center">
                            ...
                            <div>
                              <span className="badge bg-danger/10 text-danger whitespace-nowrap">
                                20-06-2023
                              </span>
                            </div>
                          </div>
                        ...
                        <li>
                          <div className="flex items-center">
                            ...
                            <div>
                              <span className="badge bg-secondary/10 text-secondary whitespace-nowrap">
                                24-07-2023
                              </span>
                            </div>
                          </div>
                ...
                <div className="xl:col-span-6 col-span-12">
                  <div className="box">
                    <div className="box-header justify-between">
                      <div className="box-title">Recent Messages</div>
                      <button
                        type="button"
                    ...
                    <div className="box-body">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div>
                          <i className="ri-check-double-line me-1 align-middle text-[#8c9097] dark:text-white/50 inline-flex"></i>
                          Mark as read
                        </div>
                      </div>
                      <div className="mt-6">
                          ...
                          <li>
                            <div className="flex flex-wrap items-center">
                              ...
                              <div className="flex-grow">
                                ...
                                <span className="text-[0.75rem] text-[#8c9097] dark:text-white/50 block text-truncate message">
        ...
        <div className="xxl:col-span-3 xl:col-span-12 col-span-12">
          <div className="grid grid-cols-12 gap-x-6">
                  ...
                  <div className="flex items-start justify-between mb-6">
                    <div>
                      ...
                      <span className="block text-[0.75rem] text-[#8c9097] dark:text-white/50">
                        ...
                        >
                          Click Here
                          <i className="bi bi-box-arrow-up-right text-[0.625rem] ms-2 align-middle"></i>
                        </Link>
                      </span>
                    </div>
                    <div>
            ...
            <div className="xxl:col-span-12 xl:col-span-4 col-span-12">
              <div className="box">
                <div className="box-header justify-between">
                  <div className="box-title">Favourite Contacts</div>
                  <button
                    type="button"
                    className="ti-btn ti-btn-light !py-1 !px-2 !text-[0.75rem]"
                  >
